...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | debug whoops secret keys blacklisting
    |--------------------------------------------------------------------------
    |
    | This array of keys that should be blacklisted by default to prevent from
    | showing in case of debugging the application
    |
    |
    |
    */
